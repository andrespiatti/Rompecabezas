...
var instrucciones = ['Mover piezas adyacentes al espacio vacio hacia dicho espacio.', 'Continuar moviendo piezas hasta formar la imagen.', 'No se podra saltear piezas.'];
...
var ultimoMovimiento = function(direccion){
...
function mostrarCartelGanador() {
  if(chequearSiGano() === true){
    alert('Has Ganado!!!  Felicitaciones!! Te animas a probar de nuevo?');
  }else{
    return false;
  }
}
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  var posicionPieza1 = grilla[filaPos1][columnaPos1];
  grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
  grilla[filaPos2][columnaPos2] = posicionPieza1;
}
